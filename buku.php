  ...
  <body>
    <div class="topnav">
  	...
  	<div class="container">
          ...
          <a href="add.php" class="x btn btn-primary" >Mau Pesan?</a>
          <br /><br />
            ...
            <tbody>
              ...
              <?php while($pemesanan = mysqli_fetch_array($result)): ?>
                <tr>
                  ...
                  <td>
                    <a href="edit.php?id=<?php echo $pemesanan['id']?>"
                      class="btn btn-success btn-sm">Ubah</a><br><br>
                      <a href="delete.php?id=<?php echo $pemesanan['id']?>" class="btn btn-danger btn-sm"
